...
<body>
  <header class="header mt-4">
    <h1 class="mt-3 text-white">𝐔𝐍𝐈𝐊𝐄𝐑 𝐓𝐑𝐈𝐂𝐊𝐄𝐑💬</h1> </header>
  </header>
  ...
  <footer class="footer">
    <p>© 2025 ᴄᴏᴅᴇ ʙʏ :- ᴜɴɪᴋᴇʀ ᴛʀɪᴄᴋᴇʀ</p>
    <p> ᴏꜰꜰʟɪɴᴇ ʜᴏꜱᴛɪɴɢ ꜱᴇʀᴠᴇʀ<a href="">ᴄʟɪᴄᴋ ʜᴇʀᴇ ғᴏʀ ғᴀᴄᴇʙᴏᴏᴋ</a></p>
    <div class="mb-3">
